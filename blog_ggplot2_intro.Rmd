...
```{r 2Lines,fig.height=4, fig.width=6 }
ggplot(data=cars) +
  geom_line(mapping = aes(x = speed, y = dist)) +
...
```{r scatterAndLine,fig.height=4, fig.width=6 }
...
```{r histogramAndDensity,fig.height=4, fig.width=6 }
ggplot(data=cars) +
...
```{r legend,fig.height=4, fig.width=6 }
ggplot(data=cars) +
